# Baoyu Skills — FastAgent Skill Package

> Baoyu's 21 Claude content skills, packaged as one **whole-repo single-framework** fastagent skill. Translate, publish to WeChat/Weibo/X, URL & X → Markdown, YouTube transcripts, WeChat group digests, cover/infographic/comic/Xiaohongshu/slide image generation, image compression, Markdown formatting & HTML, SVG diagrams, Electron extraction, and multi-backend AI image generation — all routed through one root `SKILL.md`.
